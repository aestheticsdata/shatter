 ...
 *
 * One pass is 93 tickets (see `TIER_TICKETS`): every capsule in the roster, three
 ...
 * at about 12 capsules seeded per level is roughly sixteen levels in the worst case
