...
export const SNAIL: Species = {
  ...
  tip: "KILL IT EARLY OR FIGHT THE SAME WALL TWICE",
  lore: "THE WALL'S OLD MASON. IT PACES A FLAT RUN OF BRICKS, LEFT AND RIGHT, AND EVERY BRICK IT CROSSES GETS A HIT POINT BACK — SLOWLY, PATIENTLY, FOREVER. IT WILL NOT CLIMB AND IT WILL NOT HOVER: KNOCK THE BRICK OUT FROM UNDER IT AND IT TUMBLES DOWN THE COLUMN. ALL THE WAY TO THE FLOOR, AND IT GOES SPLAT.",
  solid: true,
  frames: SNAIL_FRAMES,
  frameTicks: 12,
