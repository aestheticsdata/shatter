...
export const SPIDER: Species = {
  ...
  tip: "LEARN ITS COLUMN · IT NEVER WARNS YOU",
  lore: "IT HANGS FROM THE CEILING ON A SINGLE THREAD, STILL AS STONE, WATCHING THE COLUMN BENEATH IT. PASS UNDER IT AND IT DROPS TO THE BALL'S HEIGHT IN AN INSTANT, A LIVING SHELF THAT SENDS YOUR SHOT STRAIGHT BACK. THEN IT CLIMBS HOME AND WAITS AGAIN. CATCH IT ON THE WAY DOWN AND THE THREAD SNAPS.",
  solid: true,
  frames: [SPREAD, SWUNG],
  frameTicks: 10,
