...
export const MOTH: Species = {
  ...
  tip: "LEAD IT ON ITS LOOP, THEN CATCH WHAT FALLS",
  lore: "A SILVER-DUSTED DRIFTER THAT CANNOT KEEP AWAY FROM THE EYE. IT LOOPS ROUND IT ALL DAY LONG, NEVER QUITE WHERE IT WAS A MOMENT AGO, CLUTCHING A CAPSULE NOBODY REMEMBERS GIVING IT. IT NEVER FIGHTS BACK. ONE CLEAN HIT AND IT LETS GO OF ITS TREASURE — THE KINDEST GIFT IN THE WATCHED ROOMS.",
  solid: false,
  frames: MOTH_FRAMES,
  frameTicks: 6,
