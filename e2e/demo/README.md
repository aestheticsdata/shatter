...
| Bestiary | `C`; the eighteen cards, one creature a page, drawn big and moving — the species in the order a player meets them and the four bosses last; clicked back to the title                                                                                                                                                                                  |
